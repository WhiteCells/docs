...
将 icon 文件移动到 `~/.local/share/icons`

```sh
mv ./squashfs-root/usr/share/icons/hicolor/64x64/apps/xxx.png ~/.local/share/icons
```

将 AppImage 文件移动到 `~/.local/bin`（可以用命令行启动程序）

```sh
mv ./xxx.AppImage ~/.local/bin
```
